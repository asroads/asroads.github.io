---
title: Cocos Creator游戏开发|PureMVC
comments: true
categories: game
tags:
  - Cocos
...
![image-20200708141828268](Cocos-Creator游戏开发-PureMVC/image-20200708141828268.png)
...
![image-20200708142825508](Cocos-Creator游戏开发-PureMVC/image-20200708142825508.png)
...
![image-20200708145151332](Cocos-Creator游戏开发-PureMVC/image-20200708145151332.png)

2. 首先下载仓库到本地，然后把bin 目录的 .d.ts文件 .js文件（当然用min.js也可以） 复制到Cocos的assets 目录，这里我新建了一个叫lib的文件夹，专门存放第三方类库。

![image-20200708145857919](Cocos-Creator游戏开发-PureMVC/image-20200708145857919.png)

3. 然后在Cocos Creator编辑器里面选择插件方式

![image-20200708144003638](Cocos-Creator游戏开发-PureMVC/image-20200708144003638.png)

4. 此时回到代码编辑器里面，这个导出的源代码需要重新指定一下全局变量 puremvc，具体操作如下

   - 注释掉前面几行（四行，具体看图）

     ![image-20200708150044307](Cocos-Creator游戏开发-PureMVC/image-20200708150044307.png)

   - 注释掉后面几行（三行，具体看图）并添加 代码：`window.puremvc = puremvc;`

     ![image-20200708150108418](Cocos-Creator游戏开发-PureMVC/image-20200708150108418.png)
...
![image-20200708152145168](Cocos-Creator游戏开发-PureMVC/image-20200708152145168.png)

![image-20200708152158775](Cocos-Creator游戏开发-PureMVC/image-20200708152158775.png)
...
![image-20200708153006941](Cocos-Creator游戏开发-PureMVC/image-20200708153006941.png)
...
![image-20200708153401312](Cocos-Creator游戏开发-PureMVC/image-20200708153401312.png)

4. 构建后用微信开发者工具打开查看效果

![image-20200708153716663](Cocos-Creator游戏开发-PureMVC/image-20200708153716663.png)
...
![image-20200708153859136](Cocos-Creator游戏开发-PureMVC/image-20200708153859136.png)

![image-20200708153926746](Cocos-Creator游戏开发-PureMVC/image-20200708153926746.png)

解决办法：最后经查找删除 puremvc.js代码中 __extends 的定义即可

![image-20200708154114548](Cocos-Creator游戏开发-PureMVC/image-20200708154114548.png)
