---
title: 从一个UI左右无限翻页组件说起
comments: true
categories: game
tags:
  - Cocos
abbrlink: 209a8f2
date: 2021-08-31 15:14:30
---

两年前还在使用`Layabox` 的时候 就做过一个类似的翻页组件，[LayaBox2.0横向滑动特效](http://blog.asroads.com/post/86c31a9c.html) 做了`Cocos` 这些日子一直想做个类似的功能，但是一直没有时间，于是无意间在论坛发现了一个，于是开始了这篇文章，作者用的是2.4.x 版本，最初我只是做了`Cocos Creator`的语法兼容，并未修改功能，后面有网友提出 想要一个不循环的版本，于是做了个加强版本。
<!--more-->
...
![img](从一个UI左右无限翻页组件说起/1003.gif)

原作者 代码下载   [ScrollSelect.zip](https://forum.cocos.org/uploads/default/original/3X/4/8/4863dece46a8d1c432cdcdf2d8ddea7a58912f30.zip) 

### 3.x 语法兼容循环翻页效果：

![1001](从一个UI左右无限翻页组件说起/1001.gif)

### 3.x 语法兼容设置不循环翻页效果：

![1002](从一个UI左右无限翻页组件说起/1002.gif)

## 设置选项

![image](从一个UI左右无限翻页组件说起/1004.png)
...
- [【源码工具】分享一个UI左右无限翻页组件](https://forum.cocos.org/t/topic/91675)
